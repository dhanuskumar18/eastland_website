      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-[80%] px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600">
              {galleryContent.subTitle ? (
                <>
                  {galleryContent.title ? '' : 'Showcasing Exceptional Designs '}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {items.length > 0 ? (
              items.map((it, idx) => (
                <div key={idx} className="group relative h-64 rounded-2xl overflow-hidden shadow-lg cursor-pointer">
                  <Image
                    src={it.image || "/images/Services/portfolio/p1.png"}
                    alt={it.title || `Project ${idx + 1}`}
                    fill
