    ...
    <section ref={aboutUsRef} className="mx-auto max-w-[90%] sm:max-w-[80%] px-4 pb-12 sm:pb-16 md:pb-28 pt-12 sm:pt-16 md:pt-20 sm:px-6 lg:px-8 opacity-0">
      <div className="grid items-center gap-8 sm:gap-12 md:gap-16 md:grid-cols-2">
        ...
        <div className="relative w-full max-w-[520px] mx-auto md:mx-0">
          ...
          <div className="rounded-[18px] sm:rounded-[20px] md:rounded-[22px] border-2 border-slate-200 bg-white p-2 sm:p-3 shadow">
            <div className="relative aspect-[519/442] overflow-hidden rounded-[14px] sm:rounded-[16px] md:rounded-[18px]">
              <Image 
          ...
          <div className="absolute -bottom-4 -right-4 sm:-bottom-8 sm:-right-12 md:-bottom-12 md:-right-20 w-[150px] sm:w-[200px] md:w-[250px] lg:w-[300px] rounded-xl sm:rounded-2xl shadow-2xl">
            <div className="relative aspect-[365/252] overflow-hidden rounded-xl sm:rounded-2xl">
              <Image 
