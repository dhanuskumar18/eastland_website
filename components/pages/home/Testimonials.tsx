          ...
          <div className="relative w-full max-w-4xl mx-auto overflow-visible sm:overflow-hidden">
            ...
            <div ref={cardRef} className="relative flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 items-stretch bg-[#F4F4F4] rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm w-full max-w-full opacity-0 p-4 sm:p-0 overflow-hidden">
              ...
              <div className="flex-1 flex flex-col min-w-0 w-full sm:w-auto">
                {/* Quote mark icon */}
                <div className="text-gray-300 text-2xl sm:text-3xl md:text-4xl lg:text-5xl my-2 sm:my-4 flex justify-center sm:justify-start">
                  <Image src="/images/quote1.svg" alt="Quote left" width={30} height={30} className="sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-[50px] lg:h-[50px]" />
                </div>
              ...
              {/* Right quote mark */}
              <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 text-gray-300 text-2xl sm:text-3xl md:text-4xl lg:text-5xl hidden sm:block">
                <Image src="/images/quote2.svg" alt="Quote right" width={30} height={30} className="sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-[50px] lg:h-[50px]" />
              </div>
            </div>
          </div>
