    ...
    <main className="flex min-h-dvh flex-col">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="bg-transparent rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border border-emerald-200">
            <div className="grid grid-cols-1 md:grid-cols-[45%_55%] md:items-stretch">
              {/* Left Side - Contact Information */}
              <div className="p-2 sm:p-[10px] relative leading-6 sm:leading-7 md:h-full flex">
                <div className="relative z-10 rounded-xl border border-emerald-500/40 p-4 sm:p-6 md:p-[35px] bg-emerald-700 text-white w-full flex flex-col">
                  ...
                  <p className="text-sm sm:text-base text-emerald-100 mb-6 sm:mb-8 leading-6 sm:leading-7">
                    {intro ? (
                  ...
                  {(phones.length > 0 || !contactInfoSection) && (
                    <div className="mb-5 sm:mb-7 flex items-start gap-2 sm:gap-3">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        {emails.length > 0 ? (
                          emails.map((email, index) => (
                            <p key={index} className="text-sm sm:text-base">{email.value}</p>
                          ))
                        ) : (
                          <>
                            <p className="text-sm sm:text-base">eastlanddbs@hotmail.com</p>
                            <p className="text-sm sm:text-base">eastlanddbs@hotmail.com</p>
                          </>
                        )}
                      </div>
                  ...
                  {/* Address */}
                  {address && (
                    <div className="mb-6 sm:mb-8 md:mb-10 flex items-start gap-2 sm:gap-3">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-[40px] bg-transparent md:h-full flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 text-sm flex-1">
                ...
                <div className="mt-6 sm:mt-8 flex justify-center">
                  <Image
                    ...
                    width={200}
                    height={100}
                    className="opacity-100 w-32 sm:w-40 md:w-[200px] h-auto"
                  />
                </div>
              </div>
            </div>
      ...
      <section className="pb-0">
        <div>
          <div className="relative h-[250px] sm:h-[300px] md:h-[364px] w-full overflow-hidden shadow-lg">
            {/* Google Map */}
            <iframe
            ...
            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 md:top-8 md:right-8 bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-5 md:p-6 max-w-[calc(100%-2rem)] sm:max-w-md border border-emerald-100">
              ...
              <div className="mt-3 sm:mt-4 inline-flex items-center gap-2 rounded-full bg-emerald-600 text-white px-2 sm:px-3 py-1 text-xs">
                <svg className="h-3 w-3 sm:h-4 sm:w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
